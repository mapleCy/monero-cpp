...
A C++ library for creating Monero applications using native bindings to [monero v0.17.0.0 'Nitrogen Nebula'](https://github.com/monero-project/monero/tree/v0.17.0.0).
