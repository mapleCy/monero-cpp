...
A C++ library for creating Monero applications using native bindings to [monero v0.17.0.1 'Nitrogen Nebula'](https://github.com/monero-project/monero/tree/v0.17.0.1).
