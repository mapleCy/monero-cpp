...
A C++ library for creating Monero applications using native bindings to [monero v0.17.1.3 'Oxygen Orion'](https://github.com/monero-project/monero/tree/v0.17.1.3).
